...
public class ViewBusquedaAvanzada extends CustomComponent implements Serializable {
	...
	@AutoGenerated
	private TextField tf_etiquetas;
	@AutoGenerated
	...
	private void llenarImputs() {
		...
		tf_etiquetas.setNullRepresentation("");
...
//		criterioBusqueda.setEtiqueta(tf_etiquetas.getValue());
	...
	private GridLayout buildGridLayout_1() {
		...
		// tf_etiquetas
		tf_etiquetas = new TextField();
		tf_etiquetas.setCaption("Etiqueta");
		tf_etiquetas.setImmediate(false);
		tf_etiquetas.setWidth("90.0%");
		tf_etiquetas.setHeight("-1px");
		gridLayout_1.addComponent(tf_etiquetas, 2, 0);
