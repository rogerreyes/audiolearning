...
public class BandejaDenuncias extends CustomComponent implements View {
	...
	private void init() {
		...
		table_1.setVisibleColumns("administracion", "id", "audio.titulo", "estado", "fechaApertura",
				"numeroDenuncias");
		table_1.setColumnHeaders("ADMINISTRACION", "ID DENUNCIA", "NOMBRE DEL AUDIO", "ESTADO", "FECHA APERTURA",
				"NUMERO DENUNCIAS");
