...
public class AdministracionCategorias extends CustomComponent implements View {
	...
	private Object construirAdmin(Table source, Object itemId, Object columnId) {
		...
		editCategoria.addClickListener(e -> editCategoria(categoria));
	...
	private void editCategoria(Categoria categoria) {
		...
		Window w = new Window();
		w.setContent(new ViewCategoria());
		w.setWidth("-1px");
		w.setHeight("-1px");
		w.center();
		w.setModal(true);
	...
	private HorizontalLayout buildHl_cabecera() {
		...
		b_addCategoria.setImmediate(false);
	...
	private VerticalLayout buildVerticalLayout_2() {
		...
		table_categorias.setHeight("-1px");
		verticalLayout_2.addComponent(table_categorias);
		verticalLayout_2.setExpandRatio(table_categorias, 1.0f);
